...
var app = (function () {
    ...
    function quickselect$1(array, k, left = 0, right = array.length - 1, compare = ascending$4) {
      while (right > left) {
        if (right - left > 600) {
    ...
    function quantileSorted$1(values, p, valueof = number$5) {
      if (!(n = values.length)) return;
    ...
    function transformer$3() {
      ...
      function rescale() {
        ...
        if (clamp !== identity$a) clamp = clamper(domain[0], domain[n - 1]);
    ...
    function continuous() {
      return transformer$3()(identity$a, identity$a);
    }
    ...
    function formatLocale$3(locale) {
      var group = locale.grouping === undefined || locale.thousands === undefined ? identity$9 : formatGroup$1(map$2.call(locale.grouping, Number), locale.thousands + ""),
          currencyPrefix = locale.currency === undefined ? "" : locale.currency[0] + "",
          currencySuffix = locale.currency === undefined ? "" : locale.currency[1] + "",
          decimal = locale.decimal === undefined ? "." : locale.decimal + "",
          numerals = locale.numerals === undefined ? identity$9 : formatNumerals$1(map$2.call(locale.numerals, String)),
    ...
    function radial$1() {
      ...
      scale.range = function(_) {
        return arguments.length ? (squared.range((range = Array.from(_, number$4)).map(square$1)), scale) : range.slice();
      };
    ...
    function formatDayOfYear$1(d, p) {
      return pad$3(1 + timeDay$1.count(timeYear$1(d), d), p, 3);
    }
    ...
    function formatWeekNumberSunday$1(d, p) {
      return pad$3(sunday$1.count(timeYear$1(d) - 1, d), p, 2);
    }
    ...
    function formatWeekNumberISO$1(d, p) {
      d = dISO$1(d);
      return pad$3(thursday$1.count(timeYear$1(d), d) + (timeYear$1(d).getDay() === 4), p, 2);
    }
    ...
    function formatWeekNumberMonday$1(d, p) {
      return pad$3(monday$1.count(timeYear$1(d) - 1, d), p, 2);
    }
    ...
    function formatUTCWeekNumberSunday$1(d, p) {
      return pad$3(utcSunday$1.count(utcYear$3(d) - 1, d), p, 2);
    }
    ...
    function formatUTCWeekNumberISO$1(d, p) {
      d = UTCdISO$1(d);
      return pad$3(utcThursday$1.count(utcYear$3(d), d) + (utcYear$3(d).getUTCDay() === 4), p, 2);
    }
    ...
    function formatUTCWeekNumberMonday$1(d, p) {
      return pad$3(utcMonday$1.count(utcYear$3(d) - 1, d), p, 2);
    }
    ...
    function sequential() {
      var scale = linearish(transformer$2()(identity$a));
    ...
    function transformer$1() {
      ...
      function range(interpolate) {
        return function(_) {
          var r0, r1, r2;
          return arguments.length ? ([r0, r1, r2] = _, interpolator = piecewise$1(interpolate, [r0, r1, r2]), scale) : [interpolator(0), interpolator(0.5), interpolator(1)];
        };
      }
    ...
    function diverging$1() {
      var scale = linearish(transformer$1()(identity$a));
    ...
    /* src/components/GenerationMap.svelte generated by Svelte v3.46.4 */

    const { console: console_1$2 } = globals;
    const file$3 = "src/components/GenerationMap.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "info-box");
    			add_location(div, file$3, 52, 4, 1934);
    			attr_dev(sodipodi_namedview, "bordercolor", "#666666");
    			attr_dev(sodipodi_namedview, "objecttolerance", "10");
    			attr_dev(sodipodi_namedview, "pagecolor", "#ffffff");
    			attr_dev(sodipodi_namedview, "borderopacity", "1");
    			attr_dev(sodipodi_namedview, "gridtolerance", "10");
    			attr_dev(sodipodi_namedview, "guidetolerance", "10");
    			attr_dev(sodipodi_namedview, "inkscape:cx", "509.19152");
    			attr_dev(sodipodi_namedview, "inkscape:cy", "282.2353");
    			attr_dev(sodipodi_namedview, "inkscape:zoom", "1.2137643");
    			attr_dev(sodipodi_namedview, "showgrid", "false");
    			attr_dev(sodipodi_namedview, "id", "namedview71");
    			attr_dev(sodipodi_namedview, "inkscape:current-layer", "g5");
    			attr_dev(sodipodi_namedview, "inkscape:window-maximized", "1");
    			attr_dev(sodipodi_namedview, "inkscape:window-y", "-8");
    			attr_dev(sodipodi_namedview, "inkscape:window-x", "-8");
    			attr_dev(sodipodi_namedview, "inkscape:pageopacity", "0");
    			attr_dev(sodipodi_namedview, "inkscape:window-height", "1017");
    			attr_dev(sodipodi_namedview, "inkscape:window-width", "1920");
    			attr_dev(sodipodi_namedview, "inkscape:pageshadow", "2");
    			add_location(sodipodi_namedview, file$3, 54, 12, 2676);
    			attr_dev(path0, "id", "path58");
    			attr_dev(path0, "fill", path0_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func_1).gen));
    			attr_dev(path0, "d", "M975.8,353.8l-1.1-1.6l-1-0.8l1.1-1.6l2.2,1.5L975.8,353.8z");
    			attr_dev(path0, "class", "svelte-1wn11mc");
    			add_location(path0, file$3, 69, 20, 4019);
    			attr_dev(circle, "id", "circle60");
    			attr_dev(circle, "fill", circle_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func_2).gen));
    			attr_dev(circle, "stroke", "#FFFFFF");
    			attr_dev(circle, "stroke-width", "1.5");
    			attr_dev(circle, "cx", "975.3");
    			attr_dev(circle, "cy", "351.8");
    			attr_dev(circle, "r", "5");
    			attr_dev(circle, "class", "svelte-1wn11mc");
    			add_location(circle, file$3, 70, 20, 4186);
    			attr_dev(g0, "id", "DC");
    			add_location(g0, file$3, 68, 16, 3987);
    			attr_dev(g1, "id", "g5");
    			add_location(g1, file$3, 55, 12, 3169);
    			attr_dev(path1, "id", "path67");
    			attr_dev(path1, "fill", "none");
    			attr_dev(path1, "stroke", "#A9A9A9");
    			attr_dev(path1, "stroke-width", "2");
    			attr_dev(path1, "d", "M385,593v55l36,45 M174,525h144l67,68h86l53,54v46");
    			attr_dev(path1, "class", "svelte-1wn11mc");
    			add_location(path1, file$3, 74, 12, 4394);
    			...
    			attr_dev(svg, "xmlns:inkscape", "http://www.inkscape.org/namespaces/inkscape");
    			attr_dev(svg, "xmlns:sodipodi", "http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd");
    			attr_dev(svg, "xmlns:svg", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "id", "us-map");
    			attr_dev(svg, "preserveAspectRatio", "xMinYMin meet");
    			attr_dev(svg, "sodipodi:docname", "Republican_Party_presidential_primaries_results,_2016.svg");
    			attr_dev(svg, "inkscape:version", "0.91 r13725");
    			attr_dev(svg, "x", "0px");
    			attr_dev(svg, "y", "0px");
    			attr_dev(svg, "width", "959px");
    			attr_dev(svg, "height", "593px");
    			attr_dev(svg, "viewBox", "174 100 959 593");
    			attr_dev(svg, "enable-background", "new 174 100 959 593");
    			attr_dev(svg, "xml:space", "preserve");
    			add_location(svg, file$3, 53, 8, 1968);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*mapData, $SelectedStatesAbbrv, colorScale, stateData*/ 30) {
    				each_value = /*mapData*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*colorScale*/ 4 && path0_fill_value !== (path0_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func_1).gen))) {
    				attr_dev(path0, "fill", path0_fill_value);
    			}

    			if (dirty & /*colorScale*/ 4 && circle_fill_value !== (circle_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func_2).gen))) {
    ...
    function create_each_block$1(ctx) {
    	...
    	function func(...args) {
    		return /*func*/ ctx[5](/*path*/ ctx[10], ...args);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[6](/*path*/ ctx[10]);
    	}

    	const block = {
    		c: function create() {
    			path = svg_element("path");
    			attr_dev(path, "id", path_id_value = /*path*/ ctx[10].id);

    			attr_dev(path, "class", path_class_value = "" + (null_to_empty(/*$SelectedStatesAbbrv*/ ctx[3].includes(/*path*/ ctx[10].id)
    			? "selected"
    			: "") + " svelte-1wn11mc"));

    			attr_dev(path, "d", path_d_value = /*path*/ ctx[10].d);
    			attr_dev(path, "fill", path_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func).gen));
    			add_location(path, file$3, 57, 20, 3241);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*mapData*/ 2 && path_id_value !== (path_id_value = /*path*/ ctx[10].id)) {
    				attr_dev(path, "id", path_id_value);
    			}

    			if (dirty & /*$SelectedStatesAbbrv, mapData*/ 10 && path_class_value !== (path_class_value = "" + (null_to_empty(/*$SelectedStatesAbbrv*/ ctx[3].includes(/*path*/ ctx[10].id)
    			? "selected"
    			: "") + " svelte-1wn11mc"))) {
    				attr_dev(path, "class", path_class_value);
    			}

    			if (dirty & /*mapData*/ 2 && path_d_value !== (path_d_value = /*path*/ ctx[10].d)) {
    				attr_dev(path, "d", path_d_value);
    			}

    			if (dirty & /*colorScale, mapData*/ 6 && path_fill_value !== (path_fill_value = /*colorScale*/ ctx[2](/*stateData*/ ctx[4].find(func).gen))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:16) {#each mapData as path}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "map");
    			add_location(div, file$3, 49, 0, 1884);
    		},
    ...
    const func_1 = state => state.abbrev == "DC";
    const func_2 = state => state.abbrev == "DC";

    function instance$3($$self, $$props, $$invalidate) {
    	let $SelectedYear;
    	let $SelectedStatesAbbrv;
    	validate_store(SelectedYear, 'SelectedYear');
    	component_subscribe($$self, SelectedYear, $$value => $$invalidate(7, $SelectedYear = $$value));
    	...
    	validate_slots('GenerationMap', slots, []);
    	let data;
    	let mapData;
    	let view;
    	let colorScale;
    	...
    	onMount(async () => {
    		...
    		$$invalidate(1, mapData = await mapFetched.json());
    		$$invalidate(0, data = rawData.filter(record => record.YEAR == $SelectedYear && record["ENERGY SOURCE"] == selectedMapEnergySource && record["TYPE OF PRODUCER"] == "Total Electric Power Industry" && record["STATE_ABBREV"] !== "US-Total" && record["STATE_ABBREV"] !== "US-TOTAL"));
    		console.log(data);

    		let stateList = [
    			...new Set(data.map(record => {
    					return record.STATE_ABBREV;
    				}))
    		];
    		...
    		$$invalidate(2, colorScale = linear$2().domain([
    			Math.min(...stateData.map(state => state.gen)),
    			Math.max(...stateData.map(state => state.gen))
    		]).range(["#eeeeee", "#4682B4"]));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<GenerationMap> was created with unknown prop '${key}'`);
    	});

    	const func = (path, state) => state.abbrev == path.id;
    	...
    	const click_handler = path => {
    		if ($SelectedStatesAbbrv.includes(path.id)) {
    			...
    			SelectedStatesAbbrv.set($SelectedStatesAbbrv);
    		} else {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('mapData' in $$props) $$invalidate(1, mapData = $$props.mapData);
    		if ('view' in $$props) view = $$props.view;
    		if ('colorScale' in $$props) $$invalidate(2, colorScale = $$props.colorScale);
    		if ('stateData' in $$props) $$invalidate(4, stateData = $$props.stateData);
    		if ('selectedMapEnergySource' in $$props) selectedMapEnergySource = $$props.selectedMapEnergySource;
    	};
    ...
    class GenerationMap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function thresholdFreedmanDiaconis(values, min, max) {
      return Math.ceil((max - min) / (2 * (quantile(values, 0.75) - quantile(values, 0.25)) * Math.pow(count$1(values), -1 / 3)));
    }
    ...
    /* src/components/GenerationLineChart.svelte generated by Svelte v3.46.4 */

    const { console: console_1$1 } = globals;
    const file$2 = "src/components/GenerationLineChart.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 185, 0, 5585);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		let svg = select("#chart").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", `translate(${margin.left},${margin.top})`);

    		const fetched = await fetch("static/new_data.json");
    		let rawData = await fetched.json();
    		let statesD = rawData.filter(record => record.YEAR == selectedYear && record["ENERGY SOURCE"] == selectedResource);
    		...
    		let i = 0;
    		let colorSample = sequential().domain([0, 52]).interpolator(rainbow);

    		for (const state of stateList) {
    			if (selectedStates.includes(state)) stateColor.push(colorSample(i));
    			++i;
    		}

    		let colorScale = ordinal().domain(selectedStates).range(stateColor);

    		//Only shows total generation here
    		for (const state of selectedStates) {
    			let stateData = rawData.filter(record => record.YEAR == selectedYear && record["ENERGY SOURCE"] == selectedResource && record.STATE_ABBREV == state && record["TYPE OF PRODUCER"] == "Total Electric Power Industry");
    		...
    		const xAxis = time().domain(extent$1(months)).range([0, width]);

    		svg.append("g").attr("transform", `translate(0, ${height})`).call(axisBottom(xAxis));

    		//Create Y axis, use the min and max record generation as range
    		const yAxis = linear$2().domain([0, gMax]).range([height, 0]);

    		svg.append("g").call(axisLeft(yAxis));

    		//Naming of the chart
    		svg.append("text").attr("x", totalSize.w - 250).attr("y", 5).text("Year: " + selectedYear).style("font-size", "16px").attr("alignment-baseline", "middle");

    		svg.append("text").attr("x", totalSize.w - 250).attr("y", 20).text("Resource: " + selectedResource).style("font-size", "16px").attr("alignment-baseline", "middle");

    		//Create line and tooltip for each state data
    		let legendH = 50;

    		for (const stateData of formatData) {
    			svg.append("path").datum(stateData).attr("fill", "none").attr("stroke", colorScale(stateData[0].STATE_ABBREV)).attr("stroke-width", 1.5).attr("d", line().curve(natural).x(record => xAxis(record.MONTH)).y(record => yAxis(record.GENERATION))); //Specific type of curve, see detail for "d3 curve"

    			//Create the tooltip
    			const Tooltip = select("#chart").append("div").style("opacity", 0).attr("class", "tooltip").style("background-color", "white").style("border", "solid").style("border-width", "2px").style("border-radius", "5px").style("padding", "5px");

    			//Three function that change the tooltip when user hover / move / leave a cell		
    			//Add the points
    			svg.append("g").selectAll("dot").data(stateData).join("circle").style("opacity", 0.5).attr("class", "myCircle").attr("cx", record => xAxis(record.MONTH)).attr("cy", record => yAxis(record.GENERATION)).attr("r", 5).attr("stroke", record => colorScale(record.STATE_ABBREV)).attr("stroke-width", 3).attr("fill", "white").on("mouseover", function (event, record) {
    				Tooltip.style("opacity", 1);
    				this.style.opacity = 1;
    				this.style.r = 8;
    			}).on("mousemove", function (event, record) {
    				Tooltip.html(record.STATE + " " + selectedYear + "/" + record.MONTH + " Generation: " + record.GENERATION).style("left", `${event.layerX + 10}px`).style("top", `${event.layerY}px`);
    			...
    			//Create color legend
    			svg.append("circle").attr("cx", totalSize.w - 170).attr("cy", legendH - 1).attr("r", 6).style("fill", colorScale(stateData[0].STATE_ABBREV));

    			svg.append("text").attr("x", totalSize.w - 150).attr("y", legendH).text(stateData[0].STATE).style("font-size", "16px").attr("alignment-baseline", "middle");
    			legendH += 40;
    		}
    	});
    ...
    /* src/components/BarChart.svelte generated by Svelte v3.46.4 */
    ...
    function create_if_block(ctx) {
    	...
    	let line0;
    	let line1;
    	let each_value_4 = /*all_sources*/ ctx[4];
    	...
    	let each_value_1 = /*generation_values*/ ctx[5];
    	...
    	let each_value = /*xScaleTicks*/ ctx[2];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text$1("Toggle Energry Source ");
    			...
    			add_location(line1, file$1, 184, 5, 5417);
    			attr_dev(g1, "transform", "translate(0, 70)");
    			add_location(g1, file$1, 142, 4, 4167);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*all_sources, selected_sources, update_selected*/ 88) {
    				each_value_4 = /*all_sources*/ ctx[4];
    				validate_each_argument(each_value_4);
    				let i;
    			...
    			if (dirty & /*generation_values, xScaleTicks, xScaleNew, colorEnergy, alert, selected_sources*/ 46) {
    				each_value_1 = /*generation_values*/ ctx[5];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*xScaleNew, xScaleTicks*/ 6) {
    				each_value = /*xScaleTicks*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_each_block_4(ctx) {
    	...
    	let text_1;
    	let t_value = /*source*/ ctx[28] + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[8](/*source*/ ctx[28]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text$1(t_value);
    			attr_dev(rect, "x", "20");
    			attr_dev(rect, "y", 10 * /*index*/ ctx[25] + 5);
    			attr_dev(rect, "width", "5");
    			attr_dev(rect, "height", "5");

    			attr_dev(rect, "class", rect_class_value = "" + (null_to_empty(/*selected_sources*/ ctx[3].includes(/*source*/ ctx[28])
    			? "selected_check"
    			: "not_checked") + " svelte-8xmk8"));

    			add_location(rect, file$1, 131, 6, 3849);
    			attr_dev(text_1, "x", "30");
    			attr_dev(text_1, "y", 10 * /*index*/ ctx[25] + 10);
    			attr_dev(text_1, "class", "svelte-8xmk8");
    			add_location(text_1, file$1, 138, 6, 4080);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*selected_sources*/ 8 && rect_class_value !== (rect_class_value = "" + (null_to_empty(/*selected_sources*/ ctx[3].includes(/*source*/ ctx[28])
    			? "selected_check"
    			: "not_checked") + " svelte-8xmk8"))) {
    ...
    function create_if_block_1(ctx) {
    	...
    	let text_1;
    	let t_value = /*energy*/ ctx[23]["Generation Type"] + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[9](/*energy*/ ctx[23]);
    	}

    	let each_value_3 = /*xScaleTicks*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "class", "bar svelte-8xmk8");
    			attr_dev(rect, "x", "120");
    			attr_dev(rect, "y", "0");
    			...
    			add_location(rect, file$1, 148, 9, 4496);
    			attr_dev(text_1, "x", "-30");
    			attr_dev(text_1, "y", "9");
    			attr_dev(text_1, "class", "svelte-8xmk8");
    			add_location(text_1, file$1, 153, 9, 4699);
    			attr_dev(g, "transform", "translate(100, " + (/*index*/ ctx[25] * 10 + 50 + /*i*/ ctx[22] * 150) + ")");
    			add_location(g, file$1, 147, 8, 4425);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*xScaleNew*/ 2 && rect_width_value !== (rect_width_value = /*xScaleNew*/ ctx[1](/*energy*/ ctx[23].Sum))) {
    				attr_dev(rect, "width", rect_width_value);
    			}

    			if (dirty & /*xScaleNew, xScaleTicks*/ 6) {
    				each_value_3 = /*xScaleTicks*/ ctx[2];
    				validate_each_argument(each_value_3);
    				let i;
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "x1", line_x__value = 120 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]));
    			attr_dev(line, "y1", "0");
    			attr_dev(line, "x2", line_x__value_1 = 120 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]));
    			attr_dev(line, "y2", "5");
    			add_location(line, file$1, 155, 10, 4811);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, line, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScaleNew, xScaleTicks*/ 6 && line_x__value !== (line_x__value = 120 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]))) {
    				attr_dev(line, "x1", line_x__value);
    			}

    			if (dirty & /*xScaleNew, xScaleTicks*/ 6 && line_x__value_1 !== (line_x__value_1 = 120 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]))) {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*selected_sources*/ 8) show_if = /*selected_sources*/ ctx[3].includes(/*energy*/ ctx[23]["Generation Type"]);
    ...
    function create_each_block_1(ctx) {
    	...
    	let t;
    	let each_1_anchor;
    	let each_value_2 = /*state*/ ctx[20].Totals;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(text_1, "class", "svelte-8xmk8");
    			add_location(text_1, file$1, 144, 5, 4248);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScaleTicks, xScaleNew, generation_values, colorEnergy, alert, selected_sources*/ 46) {
    				each_value_2 = /*state*/ ctx[20].Totals;
    				validate_each_argument(each_value_2);
    				let i;
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(text_1, "class", "svelte-8xmk8");
    			add_location(text_1, file$1, 170, 6, 5075);
    			attr_dev(line, "class", "tick svelte-8xmk8");
    			...
    			attr_dev(line, "y2", "45");
    			add_location(line, file$1, 173, 6, 5199);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScaleTicks*/ 4 && t_value !== (t_value = /*tick*/ ctx[17] + "")) set_data_dev(t, t_value);

    			if (dirty & /*xScaleNew, xScaleTicks*/ 6 && text_1_transform_value !== (text_1_transform_value = "translate(" + (220 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17])) + ", 40) rotate(-45)")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}

    			if (dirty & /*xScaleNew, xScaleTicks*/ 6 && line_x__value !== (line_x__value = 220 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]))) {
    				attr_dev(line, "x1", line_x__value);
    			}

    			if (dirty & /*xScaleNew, xScaleTicks*/ 6 && line_x__value_1 !== (line_x__value_1 = 220 + /*xScaleNew*/ ctx[1](/*tick*/ ctx[17]))) {
    				attr_dev(line, "x2", line_x__value_1);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let div0;
    	let svg;
    	let if_block = /*instances*/ ctx[0] !== undefined && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$1, 126, 3, 3640);
    			attr_dev(div0, "id", "sidebar");
    			attr_dev(div0, "class", "svelte-8xmk8");
    			add_location(div0, file$1, 125, 2, 3617);
    			attr_dev(div1, "id", "alex-view");
    			add_location(div1, file$1, 122, 1, 3592);
    			add_location(main, file$1, 121, 0, 3584);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function colorEnergy(value) {
    	if (value["Generation Type"] == "Coal") {
    		return "black";
    	}

    	if (value["Generation Type"] == "Geothermal") {
    		return "green";
    	}

    	if (value["Generation Type"] == "Hydroelectric Conventional") {
    		return "blue";
    	}

    	if (value["Generation Type"] == "Natural Gas") {
    		return "red";
    	}

    	if (value["Generation Type"] == "Other") {
    		return "black";
    	}

    	if (value["Generation Type"] == "Petroleum") {
    		return "orange";
    	}

    	if (value["Generation Type"] == "Solar Thermal and Photovoltaic") {
    		return "yellow";
    	}

    	if (value["Generation Type"] == "Other Biomass") {
    		return "gray";
    	}

    	if (value["Generation Type"] == "Wind") {
    		return "light green";
    	}

    	if (value["Generation Type"] == "Wood and Wood Derived Fuels") {
    		return "brown";
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $SelectedYear;
    	validate_store(SelectedStatesAbbrv, 'SelectedStatesAbbrv');
    	component_subscribe($$self, SelectedStatesAbbrv, $$value => $$invalidate(11, $SelectedStatesAbbrv = $$value));
    	validate_store(SelectedYear, 'SelectedYear');
    	component_subscribe($$self, SelectedYear, $$value => $$invalidate(12, $SelectedYear = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('BarChart', slots, []);
    	const myName = "Alexander Barajas-Ritchie";
    	let instances;
    	let data = [];
    	let xScaleNew;
    	let xScaleTicks = [];
    	...
    	onMount(async () => {
    		const fetched = await fetch("static/new_data.json");
    		$$invalidate(0, instances = await fetched.json());

    		// filter by year and states
    		$SelectedStatesAbbrv.forEach(state => {
    			data.push({
    				"State": state,
    				"records": instances.filter(record => {
    					return record.YEAR == year_selected && record.STATE_ABBREV == state;
    				})
    			});
    		});
    		...
    		data.forEach(state_data => {
    			...
    			if (selected_sources.length == 0) {
    				$$invalidate(3, selected_sources = unique);
    			} else {
    			...
    			unique.forEach(genType => {
    				if (genType != "Total") {
    					let temp_data = instances.filter(data => {
    						return data["ENERGY SOURCE"] == genType && data.STATE_ABBREV == state_data.State && data.YEAR == year_selected;
    					});
    		...
    		$$invalidate(2, xScaleTicks = xScaleNew.ticks(26));
    		console.log(generation_values);
    		console.log(max);
    	...
    	function update_selected(source) {
    		if (selected_sources.includes(source)) {
    			//console.log("here")
    			$$invalidate(3, selected_sources = arrayRemove(selected_sources, source));
    		} else {
    			selected_sources.push(source);
    			$$invalidate(3, selected_sources);
    		}
    	}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<BarChart> was created with unknown prop '${key}'`);
    	});

    	const click_handler = source => {
    		update_selected(source);
    	};

    	const click_handler_1 = energy => {
    		alert(energy.Sum);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('xScaleNew' in $$props) $$invalidate(1, xScaleNew = $$props.xScaleNew);
    		if ('xScaleTicks' in $$props) $$invalidate(2, xScaleTicks = $$props.xScaleTicks);
    		if ('colorScale' in $$props) colorScale = $$props.colorScale;
    		if ('year_selected' in $$props) year_selected = $$props.year_selected;
    		if ('states_selected' in $$props) states_selected = $$props.states_selected;
    		if ('selected_sources' in $$props) $$invalidate(3, selected_sources = $$props.selected_sources);
    		if ('all_sources' in $$props) $$invalidate(4, all_sources = $$props.all_sources);
    		if ('generation_values' in $$props) $$invalidate(5, generation_values = $$props.generation_values);
    ...
    class BarChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { myName: 7 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Visual Analytics Final Project: Team 7";
    			t1 = space();
    			div8 = element("div");
    			div2 = element("div");
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "Map View";
    			t3 = space();
    			svg0 = svg_element("svg");
    			foreignObject0 = svg_element("foreignObject");
    			create_component(generationmap.$$.fragment);
    			t4 = space();
    			div7 = element("div");
    			div4 = element("div");
    			div3 = element("div");
    			div3.textContent = "Generation for States";
    			t6 = space();
    			...
    			div6 = element("div");
    			div5 = element("div");
    			div5.textContent = "Generation for States by Resource";
    			t9 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(svg0, foreignObject0);
    			mount_component(generationmap, foreignObject0, null);
    			append_dev(div8, t4);
    			...
    			mount_component(barchart, foreignObject1, null);
    			append_dev(div7, t7);
    			append_dev(div7, div6);
    			append_dev(div6, div5);
    			append_dev(div6, t9);
    			append_dev(div6, svg2);
    			append_dev(svg2, foreignObject2);
    		...
    		i: function intro(local) {
    			...
    			transition_in(generationlinechart.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(generationmap.$$.fragment, local);
    			transition_out(barchart.$$.fragment, local);
    			transition_out(generationlinechart.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(generationmap);
    			destroy_component(barchart);
    			destroy_component(generationlinechart);
    		}
    	};
