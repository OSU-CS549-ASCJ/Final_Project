...
var app = (function () {
    ...
    function bin() {
      ...
      histogram.thresholds = function(_) {
        return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant$c(slice$3.call(_)) : constant$c(_), histogram) : threshold;
      };
    ...
    function thresholdFreedmanDiaconis(values, min, max) {
      return Math.ceil((max - min) / (2 * (quantile$1(values, 0.75) - quantile$1(values, 0.25)) * Math.pow(count$2(values), -1 / 3)));
    }
    ...
    function hue$2(a, b) {
      var d = b - a;
      return d ? linear$3(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$9(isNaN(a) ? b : a);
    }

    function gamma$2(y) {
      return (y = +y) === 1 ? nogamma$1 : function(a, b) {
        return b - a ? exponential$2(a, b, y) : constant$9(isNaN(a) ? b : a);
      };
    }

    function nogamma$1(a, b) {
      var d = b - a;
      return d ? linear$3(a, d) : constant$9(isNaN(a) ? b : a);
    }
    ...
    function ticker(year, month, week, day, hour, minute) {
      ...
      function tickInterval(start, stop, count) {
        ...
        if (i === 0) return millisecond$1.every(Math.max(tickStep$1(start, stop, count), 1));
    ...
    const file$1 = "src\\components\\GenerationLineChart.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 170, 0, 5245);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		const xAxis = time().domain(extent$2(months)).range([0, width]);
    		...
    		const yAxis = linear().domain([0, gMax]).range([height, 0]);
    		...
    		for (const stateData of formatData) {
    			...
    			svg.append("g").selectAll("dot").data(stateData).join("circle").style("opacity", 0.5).attr("class", "myCircle").attr("cx", record => xAxis(record.MONTH)).attr("cy", record => yAxis(record.GENERATION)).attr("r", 5).attr("stroke", record => colorScale(record.STATE_ABBREV)).attr("stroke-width", 3).attr("fill", "white").on("mouseover", function (event, record) {
    				...
    				Tooltip.html(record.STATE + " " + selectedYear + "/" + record.MONTH + " Gneration: " + record.GENERATION).style("left", `${event.layerX + 10}px`).style("top", `${event.layerY}px`);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<GenerationLineChart> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	generationlinechart = new GenerationLineChart({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			div5 = element("div");
    			div3 = element("div");
    			div3.textContent = "Selected Image";
    			t6 = space();
    			div4 = element("div");
    			...
    			div7 = element("div");
    			div6 = element("div");
    			div6.textContent = "Generation for States by Resource";
    			t9 = space();
    			create_component(generationlinechart.$$.fragment);
    			attr_dev(h1, "x", "50");
    			attr_dev(h1, "class", "svelte-1vez0ch");
    			add_location(h1, file, 5, 1, 109);
    			attr_dev(div0, "class", "view-title svelte-1vez0ch");
    			add_location(div0, file, 11, 4, 270);
    			attr_dev(svg0, "class", "imagedot svelte-1vez0ch");
    			add_location(svg0, file, 12, 4, 321);
    			attr_dev(div1, "id", "projection-view");
    			attr_dev(div1, "class", "view-panel svelte-1vez0ch");
    			add_location(div1, file, 10, 3, 219);
    			attr_dev(div2, "id", "map-view");
    			attr_dev(div2, "class", "svelte-1vez0ch");
    			add_location(div2, file, 8, 2, 193);
    			attr_dev(div3, "class", "view-title svelte-1vez0ch");
    			attr_dev(div3, "y", "40");
    			add_location(div3, file, 22, 4, 494);
    			attr_dev(svg1, "class", "svelte-1vez0ch");
    			add_location(svg1, file, 26, 5, 601);
    			attr_dev(div4, "id", "selected-image-view-content");
    			attr_dev(div4, "class", "svelte-1vez0ch");
    			add_location(div4, file, 24, 4, 553);
    			attr_dev(div5, "id", "generation-state-view");
    			attr_dev(div5, "class", "view-panel svelte-1vez0ch");
    			add_location(div5, file, 21, 3, 437);
    			attr_dev(div6, "class", "view-title svelte-1vez0ch");
    			add_location(div6, file, 34, 4, 715);
    			attr_dev(div7, "id", "generation-state-resource-view");
    			attr_dev(div7, "class", "view-panel svelte-1vez0ch");
    			add_location(div7, file, 32, 3, 647);
    			attr_dev(div8, "id", "sub-section");
    			attr_dev(div8, "x", "80");
    			attr_dev(div8, "y", "80");
    			attr_dev(div8, "class", "svelte-1vez0ch");
    			add_location(div8, file, 19, 2, 394);
    			attr_dev(div9, "id", "container");
    			attr_dev(div9, "class", "svelte-1vez0ch");
    			add_location(div9, file, 6, 1, 167);
    			attr_dev(main, "class", "svelte-1vez0ch");
    			add_location(main, file, 4, 0, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div7, t9);
    			mount_component(generationlinechart, div7, null);
    			current = true;
    		},
    		p: noop$5,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ GenerationLineChart });
    	return [];
    }
