...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 51, 4, 1896);
    			...
    			add_location(sodipodi_namedview, file$3, 53, 12, 2640);
    			...
    			add_location(path0, file$3, 69, 20, 4079);
    			...
    			add_location(circle, file$3, 70, 20, 4247);
    			attr_dev(g0, "id", "DC");
    			add_location(g0, file$3, 68, 16, 4046);
    			attr_dev(g1, "id", "g5");
    			add_location(g1, file$3, 54, 12, 3134);
    			...
    			add_location(path1, file$3, 74, 12, 4459);
    			...
    			add_location(svg, file$3, 52, 8, 1931);
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 56, 20, 3208);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:16) {#each mapData as path}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "map");
    			add_location(div, file$3, 48, 0, 1843);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, data = rawData.filter(record => record.YEAR == $SelectedYear && record["ENERGY SOURCE"] == selectedMapEnergySource && record["TYPE OF PRODUCER"] == "Total Electric Power Industry" && record["STATE_ABBREV"] !== "US-Total"));
    		console.log(data);
